...
;  the underscore.
;-------------------------------------------------------------------
export  UART_MIRR_SetTxIntMode
export _UART_MIRR_SetTxIntMode
export  UART_MIRR_EnableInt
export _UART_MIRR_EnableInt
export  UART_MIRR_DisableInt
export _UART_MIRR_DisableInt

export  UART_MIRR_Start
export _UART_MIRR_Start
export  UART_MIRR_Stop
export _UART_MIRR_Stop
export  UART_MIRR_SendData
export _UART_MIRR_SendData
export  UART_MIRR_bReadTxStatus
export _UART_MIRR_bReadTxStatus
export  UART_MIRR_bReadRxData
export _UART_MIRR_bReadRxData
export  UART_MIRR_bReadRxStatus
export _UART_MIRR_bReadRxStatus

export  UART_MIRR_IntCntl
export _UART_MIRR_IntCntl

export  UART_MIRR_TxIntMode
export _UART_MIRR_TxIntMode

export  UART_MIRR_PutSHexByte
export _UART_MIRR_PutSHexByte
export  UART_MIRR_PutSHexInt
export _UART_MIRR_PutSHexInt

export  UART_MIRR_CPutString
export _UART_MIRR_CPutString
export  UART_MIRR_PutString
export _UART_MIRR_PutString
export  UART_MIRR_PutChar
export _UART_MIRR_PutChar
export  UART_MIRR_Write
export _UART_MIRR_Write
export  UART_MIRR_CWrite
export _UART_MIRR_CWrite

export  UART_MIRR_cGetChar
export _UART_MIRR_cGetChar
export  UART_MIRR_cReadChar
export _UART_MIRR_cReadChar
export  UART_MIRR_iReadChar
export _UART_MIRR_iReadChar
export  UART_MIRR_PutCRLF
export _UART_MIRR_PutCRLF

IF (UART_MIRR_RXBUF_ENABLE)
export  UART_MIRR_CmdReset
export _UART_MIRR_CmdReset
export  UART_MIRR_bCmdCheck
export _UART_MIRR_bCmdCheck
export  UART_MIRR_bCmdLength
export _UART_MIRR_bCmdLength
export  UART_MIRR_bErrCheck
export _UART_MIRR_bErrCheck

export  UART_MIRR_szGetParam
export _UART_MIRR_szGetParam
export  UART_MIRR_szGetRestOfParams
export _UART_MIRR_szGetRestOfParams
ENDIF
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
export  bUART_MIRR_ReadTxStatus
export _bUART_MIRR_ReadTxStatus
export  bUART_MIRR_ReadRxData
export _bUART_MIRR_ReadRxData
export  bUART_MIRR_ReadRxStatus
export _bUART_MIRR_ReadRxStatus
...
area UART_MIRR_RAM (RAM, REL, CON)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_EnableInt
;
;  DESCRIPTION:
...
;
 UART_MIRR_EnableInt:
_UART_MIRR_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_EnableIntMask UART_MIRR_TX_INT_REG, UART_MIRR_TX_INT_MASK
   M8C_EnableIntMask UART_MIRR_RX_INT_REG, UART_MIRR_RX_INT_MASK
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 UART_MIRR_DisableInt:
_UART_MIRR_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_DisableIntMask UART_MIRR_TX_INT_REG, UART_MIRR_TX_INT_MASK
   M8C_DisableIntMask UART_MIRR_RX_INT_REG, UART_MIRR_RX_INT_MASK
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_SetTxIntMode(BYTE bTxIntMode)
;
;  DESCRIPTION:
...
;
 UART_MIRR_SetTxIntMode:
_UART_MIRR_SetTxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1
   M8C_SetBank1
   and   A, UART_MIRR_INT_MODE_TX_COMPLETE
   jz    .SetModeRegEmpty
   or    REG[UART_MIRR_TX_FUNC_REG], bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.SetModeRegEmpty:
   and   REG[UART_MIRR_TX_FUNC_REG], ~bfFUNCTION_REG_TX_INT_MODE_BIT
   M8C_SetBank0
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_Start(BYTE bParity)
;
;  DESCRIPTION:
...
_UART_MIRR_Start:
   ...
   mov   REG[UART_MIRR_TX_CONTROL_REG], A
   mov   REG[UART_MIRR_RX_CONTROL_REG], A
IF ( UART_MIRR_RXBUF_ENABLE )
   call  _UART_MIRR_CmdReset
ENDIF
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
_UART_MIRR_Stop:
   RAM_PROLOGUE RAM_USE_CLASS_1
   and   REG[UART_MIRR_TX_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   and   REG[UART_MIRR_RX_CONTROL_REG], ~bfCONTROL_REG_START_BIT
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_SendData
;
;  DESCRIPTION:
...
_UART_MIRR_SendData:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov REG[UART_MIRR_TX_BUFFER_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_bReadTxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 UART_MIRR_bReadTxStatus:
_UART_MIRR_bReadTxStatus:
 bUART_MIRR_ReadTxStatus:                        ; For backwards compatibility only
_bUART_MIRR_ReadTxStatus:                        ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[UART_MIRR_TX_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_bReadRxData
;
;  DESCRIPTION:
...
;    functions.
;
 UART_MIRR_bReadRxData:
_UART_MIRR_bReadRxData:
 bUART_MIRR_ReadRxData:                          ; For backwards compatibility only
_bUART_MIRR_ReadRxData:                          ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A, REG[UART_MIRR_RX_BUFFER_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_bReadRxStatus
;
;  DESCRIPTION:
...
;    functions.
;
 UART_MIRR_bReadRxStatus:
_UART_MIRR_bReadRxStatus:
 bUART_MIRR_ReadRxStatus:                        ; For backwards compatibility only
_bUART_MIRR_ReadRxStatus:                        ; For backwards compatibility only
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov A,  REG[UART_MIRR_RX_CONTROL_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_TxIntMode
;
;  DESCRIPTION:
...
;
 UART_MIRR_TxIntMode:
_UART_MIRR_TxIntMode:
   RAM_PROLOGUE RAM_USE_CLASS_1

   and  A,UART_MIRR_INT_MODE_TX_COMPLETE
   M8C_SetBank1
   cmp  A,UART_MIRR_INT_MODE_TX_COMPLETE
   jz   .SetTxCmpMode

   and  reg[UART_MIRR_TX_FUNC_REG],0xEF          ; Set Interrupt on Tx_Reg_Empty
   jmp  .TxIntMode_End

.SetTxCmpMode:                                       ; Set Interrupt on TX Complete
   or   reg[UART_MIRR_TX_FUNC_REG],0x10
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_IntCntl
;
;  DESCRIPTION:
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_PutSHexByte
;
;  DESCRIPTION:
...
.SECTION
 UART_MIRR_PutSHexByte:
_UART_MIRR_PutSHexByte:
   RAM_PROLOGUE RAM_USE_CLASS_1
   ...
   index UART_MIRR_HEX_STR             ; Get Hex value
   call  UART_MIRR_PutChar             ; Write data to screen
   pop   A                             ; Restore value
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_PutSHexInt
;
;  DESCRIPTION:
...
;
 ...
 UART_MIRR_PutSHexInt:
_UART_MIRR_PutSHexInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   swap  A,X
   call  UART_MIRR_PutSHexByte         ; Print MSB
   mov   A,X                           ; Move LSB into position
   call  UART_MIRR_PutSHexByte         ; Print LSB
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_PutChar
;
;  DESCRIPTION:
...
.BufEmptyWaitLoop:
   tst REG[UART_MIRR_TX_CONTROL_REG], UART_MIRR_TX_BUFFER_EMPTY     ; Check Tx Status
   jz  .BufEmptyWaitLoop
   mov REG[UART_MIRR_TX_BUFFER_REG], @Source     ; Write data to Tx Port
   endm
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_cGetChar
;
;  DESCRIPTION:
...
_UART_MIRR_cGetChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   tst REG[UART_MIRR_RX_CONTROL_REG],UART_MIRR_RX_REG_FULL    ; Check if a character is ready
   jz  UART_MIRR_cGetChar                              ; If not loop
   mov A, REG[UART_MIRR_RX_BUFFER_REG]                 ; Get character
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_cReadChar
;
;  DESCRIPTION:
;     Read character from UART RX port.
;-----------------------------------------------------------------------------
...
;
 UART_MIRR_cReadChar:
_UART_MIRR_cReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov  A,REG[UART_MIRR_RX_CONTROL_REG]                    ; Get Status of RX
   push A
   and  A,UART_MIRR_RX_COMPLETE                            ; Check if a character is ready
...
.RX_DATA_RDY:
   ...
   and  A,(UART_MIRR_RX_PARITY_ERROR | UART_MIRR_RX_FRAMING_ERROR)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_iReadChar
;
...
;
 UART_MIRR_iReadChar:
_UART_MIRR_iReadChar:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov  A,REG[UART_MIRR_RX_CONTROL_REG]                    ; Get Status of RX
                                                           ; Mask only errors and data ready
   and  A,(UART_MIRR_RX_ERROR|UART_MIRR_RX_REG_FULL)
   push A
   and  A,UART_MIRR_RX_COMPLETE                            ; Check if a character is ready
   jnz  .RX_GET_DATA                                       ; Data Ready go read it.
   pop  A
   or   A,UART_MIRR_RX_NO_DATA                             ; Add no data flag
   swap A,X
   jmp  End_UART_MIRR_iReadChar

.RX_GET_DATA:
   pop  A
   and  A,UART_MIRR_RX_ERROR
   swap A,X
   mov  A,REG[UART_MIRR_RX_BUFFER_REG ]                    ; Read data first, then
                                                           ; determine if data is valid

 End_UART_MIRR_iReadChar:
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_PutString
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_CWrite
;
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_CPutString
;
;  DESCRIPTION:
;     Send String out through UART TX port.
;-----------------------------------------------------------------------------
...
;    functions.
;
 UART_MIRR_CPutString:
_UART_MIRR_CPutString:
   RAM_PROLOGUE RAM_USE_CLASS_1
   push  A                                       ; Store ROM pointer
   push  X
   romx                                          ; Get character from ROM
   jz    .End_CPutString
   call  UART_MIRR_PutChar                       ; Print character
   pop   X
   pop   A
   inc   X                                       ; Inc LSB of pointer
   jnc   UART_MIRR_CPutString                    ; Check for carry
   inc   A                                       ; Inc MSB of pointer
   jmp   UART_MIRR_CPutString
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_PutCRLF
;
;  DESCRIPTION:
;     Send a CR and LF
;-----------------------------------------------------------------------------
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_CmdReset
;
;  DESCRIPTION:
...
_UART_MIRR_CmdReset:
   ...
   RAM_SETPAGE_CUR >UART_MIRR_aRxBuffer
   mov [UART_MIRR_aRxBuffer], 0x00
   RAM_SETPAGE_CUR >UART_MIRR_bRxCnt
   mov [UART_MIRR_bRxCnt], 0x00
   and [UART_MIRR_fStatus], 0x00
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_bCmdCheck
;
;  DESCRIPTION:
...
;
 UART_MIRR_bCmdCheck:
_UART_MIRR_bCmdCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >UART_MIRR_fStatus
   mov A,  [UART_MIRR_fStatus]
   and A, UART_MIRR_RX_BUF_CMDTERM               ; Mask off Command status
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_bErrCheck
;
;  DESCRIPTION:
...
;
 UART_MIRR_bErrCheck:
_UART_MIRR_bErrCheck:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >UART_MIRR_fStatus
   mov A,  [UART_MIRR_fStatus]
   and A, UART_MIRR_RX_BUF_ERROR                 ; Mask off Error status
   and [UART_MIRR_fStatus], ~UART_MIRR_RX_BUF_ERROR
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_bCmdLength
;
;  DESCRIPTION:
...
;          CUR_PP
;
 UART_MIRR_bCmdLength:
_UART_MIRR_bCmdLength:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >UART_MIRR_bRxCnt
   mov A,  [UART_MIRR_bRxCnt]
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_szGetParam
;
;  DESCRIPTION:
;      Return next parameter from UART_MIRR Rx buffer
;-----------------------------------------------------------------------------
;
;  ARGUMENTS:  none
;
...
;     UART_MIRR_CmdReset which resets the entire buffer to the 'empty'
;     state. Typically this function, UART_MIRR_szGetParam, is
;     not called until the buffer has been loaded with an entire command
;     (See UART_MIRR_bCmdCheck).
;
...
;
 UART_MIRR_szGetParam:
_UART_MIRR_szGetParam:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_PROLOGUE RAM_USE_CLASS_3
    
   RAM_SETPAGE_CUR >ptrParam
   mov   A, <UART_MIRR_aRxBuffer            ; Get address to receive buffer
   add   A, [ptrParam]                      ; Add string offset
   mov   X, A
   RAM_SETPAGE_IDX >UART_MIRR_aRxBuffer
...
.ParamLoop:                                 ; Now loop until end of parameter found.
   ...
   inc   [ptrParam]
   cmp   [ptrParam], (UART_MIRR_RX_BUFFER_SIZE -1)   ; Check if we are at the end of buffer
   jz    .TerminateString
   mov   A, [X]                             ; Get next character
   jz    .End_GetNextParam
   cmp   A, UART_MIRR_DELIMITER             ; Check if we have a delimiter
   ...
   mov   [ptrParam], (UART_MIRR_RX_BUFFER_SIZE -1)   ; Reset pointer to end of string.
...
.NotNullString:
   pop  X
   mov  A, >UART_MIRR_aRxBuffer             ; Return pointer
   RAM_EPILOGUE RAM_USE_CLASS_3
   RAM_EPILOGUE RAM_USE_CLASS_4
   ret
.ENDSECTION
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: UART_MIRR_szGetRestOfParams
;
;  DESCRIPTION:
...
;          CUR_PP
;
 UART_MIRR_szGetRestOfParams:
_UART_MIRR_szGetRestOfParams:
   RAM_PROLOGUE RAM_USE_CLASS_4
   RAM_SETPAGE_CUR >ptrParam
   mov  A, <UART_MIRR_aRxBuffer             ; Get address to receive buffer
   add  A, [ptrParam]                       ; Add string offset
