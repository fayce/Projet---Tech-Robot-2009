...
export LoadConfig_asserv09_frombackup1
export _LoadConfig_asserv09_frombackup1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_asserv09_frombackup1_Ordered
	lcall	LoadConfig_asserv09_frombackup1
...
;---------------------------------------------------------------------------
; Load Configuration asserv09_frombackup1
;
;    Load configuration registers for asserv09_frombackup1.
...
;               CUR_PP
;
_LoadConfig_asserv09_frombackup1:
 LoadConfig_asserv09_frombackup1:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_asserv09_frombackup1_Bank0
    mov     X, <LoadConfigTBL_asserv09_frombackup1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_asserv09_frombackup1_Bank1
    mov     X, <LoadConfigTBL_asserv09_frombackup1_Bank1
