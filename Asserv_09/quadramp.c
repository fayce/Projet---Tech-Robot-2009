...
uint32_t quadramp_get_2nd_order_vars(struct quadramp_filter * q){
uint32_t ret;
ret =  q->var_1st_ord_pos;
return ret;
}

uint32_t quadramp_get_1st_order_vars(struct quadramp_filter * q){
uint32_t ret;
ret =  q->var_2nd_ord_pos;
return ret;

}

int32_t quadramp_get_previous_out(struct quadramp_filter * q){
uint32_t ret;
ret =  q->previous_var;
return ret;
}
